    ...
    return (
        <div className="row border border-secondary-subtle p-2 mt-0"  >
            <div className="col-sm-7 col-md-5 col-lg-3 text-center my-auto py-2">
                <img src="https://www.contrigran.co/wp-content/uploads/2021/11/manuel.jpg" className="img-fluid rounded-circle mx-2"></img>
            </div>
            <div className="col-sm-6 col-md-6 col-lg-6 ms-0 text-start ps-4 my-auto mt-0">
